...
import './DietaryDropdown.css'; // shares the same stylesheet

/**
 * CuisineDropdown  — multi-select, same visual style as DietaryDropdown
 * Props:
 ...
 */
export default function CuisineDropdown({ options = [], value = new Set(), onChange, placeholder = 'All Cuisines' }) {
